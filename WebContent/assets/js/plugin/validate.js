(function () {
  ...
  const constraints = {
	...
	loginAccount: { presence: true },
	loginPassword: { presence: true },
  ...
  function showErrorsForInput(input, errors) {
	...
	messages = formGroup.querySelector(".errorMessage");
  ...
  function resetFormGroup(formGroup) {
    ...
    formGroup.querySelector(".errorMessage").classList.add("none");
  ...
  function addError(messages, error) {
	// messages 有 i18n 屬性, 把 none class remove 時, 會按語系顯示 validate 的警告
